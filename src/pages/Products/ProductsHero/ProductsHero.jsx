...
const ProductsHero = () => {
  return (
    <div className='container sm:py-[65px] py-[5px]'>
      <div className='flex'>
        <div>
       <h2 className='w-full font-semibold text-4xl sm:text-5xl md:text-6xl sm:pt-[70px] md:pt-[40px] pt-[20px]  mb-[35px] select-none'>Explore the Latest Trends and Timeless Classics</h2>
